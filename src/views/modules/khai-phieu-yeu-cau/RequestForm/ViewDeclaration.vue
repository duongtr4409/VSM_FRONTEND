			...
			if (this.fieldData) {
				...
				for (let index in this.objectSchema.properties) {
					...
					if (this.objectSchema.properties[index]?.value) {
						console.log("this.objectSchema.properties[index]?.value",this.objectSchema.properties[index]?.value)
						try {
							let expr = parser.parse(
								this.objectSchema.properties[index]?.value,
							);
				...
				console.log("this.objectSchema.properties 2", this.objectSchema.properties);
				console.log("this.objectModel",this.objectModel)
