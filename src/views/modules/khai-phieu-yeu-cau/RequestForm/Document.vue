<template>
	<v-card elevation="0">
		<v-dialog v-model="dialog.editFolderDialog" max-width="60vw" persistent> 
			<EditFolderVue
				:item="editedItem"
				:parent="parent"
				@close="onCloseDialog"
		...
		<v-dialog v-model="dialog.deleteConfirmDialog" width="fit-content" persistent>
			<DeleteDialogVue
				@close="onCloseDialog"
				@confirmDelete="onConfirmDelete"
			/>
		</v-dialog>
		<v-dialog v-model="dialog.uploadFileDialog" max-width="60vw" persistent>
			<UploadFileVue @close="onCloseDialog" />
		</v-dialog>
		<v-dialog v-model="dialog.viewFileDialog" persistent>
