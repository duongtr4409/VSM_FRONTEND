<template>
	<v-card class="p-4" elevation="0">
		<v-tabs center-active background-color="red lighten-2" dark>
			<v-tab>{{ $t("tab.general_information") }}</v-tab>
			<v-tab> {{ $t("tab.details") }}</v-tab>
			<v-tab>{{ $t("tab.document") }}</v-tab>
			<v-tab>{{ $t("tab.process_") }}</v-tab>
		</v-tabs>
		<v-row class="mt-4 p-4">
			<h2>{{ $t("label.create_request_form") }}</h2>
			<v-col cols="12" sm="12" md="12" class="d-flex">
				<v-combobox
					:items="listRequestGroup"
					:label="$t('label.request_group')"
					outlined
			...
			<v-col cols="12" sm="12" md="12" class="d-flex">
				...
				<v-dialog v-model="dialogCreateRequestType" width="fit-content" persistent>
					<template v-slot:activator="{ on, attrs }">
						<div>
							<v-btn
								color="blue darken-1"
			...
			<v-col cols="12" sm="12" md="12" class="d-flex">
				...
				<v-dialog v-model="dialogCreateStep" width="fit-content" persistent>
					<template v-slot:activator="{ on, attrs }">
						<div>
							<v-btn
								color="blue darken-1"
			...
			<v-col cols="12" sm="12" md="12" class="d-flex">
				...
				<v-dialog v-model="dialogCreateForm" width="fit-content" persistent>
					<template v-slot:activator="{ on, attrs }">
						<div>
							<v-btn
								color="blue darken-1"
