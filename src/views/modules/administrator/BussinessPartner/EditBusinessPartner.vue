			...
			try {
				if (!this.businessPartner.id) {
					...
					this.businessPartner.name =
						this.businessPartner.name.trim();
					...
					this.businessPartner.modifiedName =
						this.user_current.fullName;
					response = await globalService.putData_Async(
						administratorAPI.API_UpdateBusinessParner(
							this.businessPartner.id,
						),
						this.businessPartner,
					);
					if (!response) {
